...
#undef main
#include <random>
uint64_t prefixes=0,graph_pairs=0,intersection_cases=0,table_cases=0,snapshots=0,groups=0,cache_checks=0,disconnected=0;
void check_tables() {
...
int main(int argc,char** argv) {
  ...
  std::cout<<"ZERO_TEST_OK prefixes="<<prefixes<<" graph_pairs="<<graph_pairs<<" intersection_cases="<<intersection_cases<<" masked_cases="<<table_cases<<" known_prefixes="<<snapshots<<" known_cell_groups="<<groups<<" cache_pairs="<<cache_checks<<" disconnected_remainders="<<disconnected<<'\n';
  return 0;
}
