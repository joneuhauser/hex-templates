...
int main(int argc,char** argv) {
  ...
  std::cout<<"MRV_TEST_OK partial_cases="<<partial_cases<<" prefixes="<<prefixes<<" graph_pairs="<<graph_pairs<<" intersection_cases="<<intersection_cases<<" masked_cases="<<table_cases<<" known_prefixes="<<snapshots<<" known_cell_groups="<<groups<<" cache_pairs="<<cache_checks<<" disconnected_remainders="<<disconnected<<'\n';
  return 0;
}
